  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function Y5(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(formBuilder, authSvc, router, toastController) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 8:
                      ...
                      this.authSvc.getUsers().once("value", function (snap) {
                        snap.forEach(function (element) {
                          var uid = element.key;

                          if (user.uid == uid) {
                            _this.router.navigate(['admin-user-view']);
                          }

                          _this.authSvc.getMonitorUsers(uid).once("value", function (snap) {
                            snap.forEach(function (element2) {
                              var monitorUid = element2.key;

                              if (user.uid == monitorUid) {
                                _this.router.navigate(['user-kategoria']);
                              }
                            });
                          });
                        });
