(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-crear-usuario-admin-crear-usuario-module~admin-user-view-admin-user-view-module~forgot~9d0d3f29"],{
...
let UsuariosFirebaseService = class UsuariosFirebaseService {
    ...
    createKategoria(apt) {
        ...
        var idKat = "12012021" + this.makeid(16);
        var monitorearenUId = "";
        this.usuarioListRef = this.db.list("/users/-MQq8A9xnvbSzOtyd9aG/erabiltzaileak/0/kategoriak/" // queriendo editar el 0
        );
        var x = {};
...
//# sourceMappingURL=default~admin-crear-usuario-admin-crear-usuario-module~admin-user-view-admin-user-view-module~forgot~9d0d3f29-es2015.js.map