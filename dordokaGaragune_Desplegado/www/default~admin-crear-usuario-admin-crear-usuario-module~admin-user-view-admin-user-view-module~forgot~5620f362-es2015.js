(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-crear-usuario-admin-crear-usuario-module~admin-user-view-admin-user-view-module~forgot~5620f362"],{
...
var tslib = __webpack_require__(/*! tslib */ "O1h7");
...
/***/ "BRfS":
/*!*******************************************************!*\
  !*** ./src/app/services/usuarios-firebase.service.ts ***!
  \*******************************************************/
/*! exports provided: UsuariosFirebaseService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UsuariosFirebaseService", function() { return UsuariosFirebaseService; });
...
let UsuariosFirebaseService = class UsuariosFirebaseService {
    constructor(db, afAuth) {
        this.db = db;
        this.afAuth = afAuth;
        this.erabiltzaileNormalaUID = "re2KbiU45PcouAHb4fThHSbs3dS2";
        this.kategoriaUID = "-MRKLVnXoBcLjP76TNsC";
        this.usuarioListRef = this.db.list("/users");
    }
    setKategoria(kategoriaUID) {
        this.kategoriaUID = kategoriaUID;
    }
    setUsuarioNormala(usuarioNormalaUID) {
        this.erabiltzaileNormalaUID = usuarioNormalaUID;
    }
    getKategoriaList() {
        console.log(this.erabiltzaileNormalaUID); //whYVI3YAsyT8YlvtXUTZo4VftMy2
        return firebase__WEBPACK_IMPORTED_MODULE_3___default.a
            .database()
            .ref("/users/" + firebase__WEBPACK_IMPORTED_MODULE_3___default.a.auth().currentUser.uid + "/erabiltzaileak/" + this.erabiltzaileNormalaUID + "/kategoriak");
    }
    getPiktogramaList() {
        return firebase__WEBPACK_IMPORTED_MODULE_3___default.a
            .database()
            .ref("/users/" + firebase__WEBPACK_IMPORTED_MODULE_3___default.a.auth().currentUser.uid + "/erabiltzaileak/" + this.erabiltzaileNormalaUID + "/kategoriak/" + this.kategoriaUID + "/piktogramak");
    }
    erabiltzaileakKargatu() {
        return firebase__WEBPACK_IMPORTED_MODULE_3___default.a
            .database()
            .ref("/users/" + firebase__WEBPACK_IMPORTED_MODULE_3___default.a.auth().currentUser.uid + "/erabiltzaileak");
    }
    makeid(length) {
        var result = "";
    ...
    createUsuario(apt) {
        ...
        var monitorearenUId = "";
        this.usuarioListRef = this.db.list("/users/-MQptEJuTP67l8RQES6K/" + /*monitorearenUId+*/ "erabiltzaileak/");
    ...
    createPiktograma(apt) {
        ...
        var idKat = "12012021" + this.makeid(16);
        var monitorearenUId = "";
        this.usuarioListRef = this.db.list("/users/-MQptEJuTP67l8RQES6K/" +
    ...
    createKategoria() {
        ...
        return this.db.list("/users/09SuFe2gNzL7lnq6Mv1CVBA8Z4u1/erabiltzaileak/re2KbiU45PcouAHb4fThHSbs3dS2/kategoriak" // metiendo kategorias de pueba
        ).push(x);
    }
    //create datos de admin google
    createUsuarioAdmin(id, name) {
        return this.usuarioListRef.push({
            uIdMonitorea: id,
            monitoreIzena: name,
            erabiltzaileak: [],
    ...
    //create datos de admin google
    createUsuarioAdminconId(id, name) {
        console.log(id, name);
        var x = {};
    ...
    createUsuarioNormal(id, name, idAdmin) {
        console.log(id, name);
        var x = {};
...
//# sourceMappingURL=default~admin-crear-usuario-admin-crear-usuario-module~admin-user-view-admin-user-view-module~forgot~5620f362-es2015.js.map